...
# J0608_out.identify('J0608',Te=30000,abun_type='abun_WC.dat')

# linefind = Spec_line_finding('J0608_03may2019MagE.fits',length=50,percentile=30,snr_threshold=7,prominence=3)
